                ...
                if line in ("[General]", "[Difficulty]", "[TimingOptions]", "[NoteTimings]"):
                    ...
                    if "=" in line:
                        ...
                        if len(line) == 3:
                            ...
                            options[last_title][note_counter]["end_timing1"] = int(line[1])
                        ...
                        # slider note
                            ...
                            options[last_title][note_counter]["end_timing1"] = int(line[2])
                            options[last_title][note_counter]["end_timing2"] = int(line[3])
...
if __name__ == "__main__":
    print(option_load("sagashi_mono.nnb", True))